#
#	(c) https://github.com/adafruit/Adafruit-uRTC
#
#	Example:
#
#	from urtc import datetime_tuple, DS1307
#	rtc = DS1307(i2c_instance)
#	newdate = datetime_tuple(year=2019,month=1,day=19,hour=10,minute=9)
